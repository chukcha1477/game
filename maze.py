...
wall1 = Wall(178,67,28,20,100,100,10)
wall2 = Wall(234,78,201,100,20,100,10)
wall3 = Wall(67,90,255,20,100,200,10)
...
win = font.render('КРУТ', True, (127,45,89))
lose = font.render('НЕ КРУТ', True,(254,230,70))
